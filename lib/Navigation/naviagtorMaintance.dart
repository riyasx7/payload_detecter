...
import 'package:payload_detecter/MainScreen/PayLoaders/QRScanner.dart';
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (loginInfo == "Admin") {
              ...
              print("payloader");
              // return PayloaderPage(storedBarcode: '192.168.9.9');
              return QrScanner(type: "Payloader");
            } else {
              print("contractor");
              return QrScanner(type: "Contracter");
            }
          }
        },
      ),
